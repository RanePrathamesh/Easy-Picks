...
import { faBoxArchive, faFolderTree, faKey } from "@fortawesome/free-solid-svg-icons";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    session && (
      ...
      >
        {/* <!-- SIDEBAR HEADER --> */}
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 border-white border-b-2">
          <Link href="/admin">
            {/* <Image
            width={176}
            height={32}
            ...
            alt="Logo"
          /> */}
            <span className="text-title-sm px-2 font-extrabold ">A' Panel</span>
          </Link>
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                ...
                <li>
                  ...
                  >
                    ...
                    <FontAwesomeIcon icon={faBoxArchive} className="fill-current"/>
                ...
                <li>
                  ...
                  >
                    <FontAwesomeIcon icon={faFolderTree} className="fill-current"/>
                    Products
                  </Link>
                </li>
                {/* <!-- Menu Item Products --> */}
            ...
            {session?.user?.role === "Admin" && (
              ...
              > */}
                  ...
                  <li>
                    ...
                    >
                      <FontAwesomeIcon icon={faKey} className="fill-current"/>
                      Configs
                    </Link>
                  </li>
                  <li>
