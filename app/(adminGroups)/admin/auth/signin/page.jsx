...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(res.error) {
        setError(`Invalid Credentials / Account Inactive`);
        return;
      }

      toast.success(`Logged In Successfully.`,tosterProps)
      redirect('/admin')
    } catch (error) {
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark  xl:border-l-2">
            <div className="w-full  p-4 sm:p-12.5 xl:p-17.5">
              {/* <span className="mb-1.5 block font-medium">Believe.</span> */}
            ...
            <div className="bg-meta-1 text-white w-fit text-sm py-1 px-3 rounded-md mt-2">
              {error}</div>)}
                ...
                <div className="mt-6 text-center">
                  <p>
                    Forgot Password?{" "}
                    <Link href="/admin/auth/resetpassword" className="text-primary">
                      Click here
                    </Link>
                  </p>
                </div>
